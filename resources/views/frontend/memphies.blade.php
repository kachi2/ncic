...
application to enroll as a  <span style="font-style: italic"> UNIVERSITY </span> student.
                    ...
                    <p>
                        By signing this form, I, <input style="border:none; border-bottom:1px solid #000; width:350px; padding-left:10px" value="{{strtoupper($name)}}">  , hereby  <span style="font-weight: bold"> waive</span>  
